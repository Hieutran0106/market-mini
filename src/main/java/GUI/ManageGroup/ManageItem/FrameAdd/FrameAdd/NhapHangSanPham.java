...
public class NhapHangSanPham extends javax.swing.JFrame {
    ...
    private void setThongTinPhieuNhap(){
        ...
        NhanVien nv = nhanvienBus.get(this.maNhanVien);
        if (nv == null) {
            this.lbTenNV.setText("<html><font color='red'>Không tìm thấy nhân viên</font>");
        } else {
            this.lbTenNV.setText("<html>"+nv.getTenNV());
        }
