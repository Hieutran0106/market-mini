...
public class SellerMainFrame extends javax.swing.JFrame {
    ...
    // Thêm biến cho combobox hình thức thanh toán
    ...
    private void initComponents() {
        ...
        // Khởi tạo combobox hình thức thanh toán
        cbPaymentMethod = new JComboBox<>();
        cbPaymentMethod.setFont(new java.awt.Font("Segoe UI", 1, 12));
        cbPaymentMethod.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiền mặt", "Chuyển khoản" }));
        ...
        // Sửa layout: Thêm cbPaymentMethod vào panel paymentInfo (dưới txtVoucher)
                ...
                paymentInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(paymentInfoLayout.createSequentialGroup()
                                .addGroup(paymentInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(paymentInfoLayout.createSequentialGroup()
                                                .addContainerGap()
                                                .addComponent(cbPaymentMethod, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(0, 0, Short.MAX_VALUE)))
                                .addContainerGap())
        );
        paymentInfoLayout.setVerticalGroup(
                paymentInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(paymentInfoLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbPaymentMethod, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void addActionEvent(){
        ...
        // Sửa dòng này: truyền thêm cbPaymentMethod vào PayActionListener
        jButton2.addActionListener(new PayActionListener(this.txtVoucher, this.txtPhoneNumber, this.lbTextTotal,
                this.lbTextDiscount, this.lbTextMoney, jButton2, scrollPanelOrder, cbPaymentMethod));
